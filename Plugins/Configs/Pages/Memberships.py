...
def Memberships():
    ...
    print(Bright_Magenta + Ms3 + Bright_Red +"). Website Developer")
    print(Bright_Magenta + Ms4 + Bright_Red +"). Graphic Design")
    print(Bright_Magenta + Ms5 + Bright_Red +"). Whiteborad Animation")
    print(Bright_Magenta + Ms6 + Bright_Red +"). Character Animation")
    print(Dark_Blue + BG_Dark_Green + Line + Rest)
    print(Dark_Blue + BG_Dark_Green + Line + Rest)
